...
from app.config import SMOKING_MODEL_PATH, DROWSINESS_MODEL_PATH
from app.inference.label_mapper import build_smoking_label_map, build_drowsiness_label_map
